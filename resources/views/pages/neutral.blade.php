...
<x-page-banner image="assets/images/page-banner.jpg" activePage='NEUTRAL STRUCTURAL SILICONE SEALANT' :pageLinks="['home' => 'Home', 'products' => 'Products', 'weather' => 'BOND 7700 Neutral Structural Silicone Sealant']" />
        ...
        <div class="row">
            <div class="col-xl-9 xl-mb-30">
                <div class="blog__details-left">
                    ...
                    <img src="{{ asset('assets/images/products/neutral-silicone-sealant.jpg') }}" class="img-fluid mb-4" loading="lazy">

                    <h4 class="mb-20">Technical Data:</h4>
                    <p>The following data are only for reference purpose, not intended for use in preparing specifica-􀆟on.</p>

                    <table class="table table-hover table-bordered">
                        <thead>
                            <tr>
                                <th colspan="4" class="text-center">BOND 7700 Neutral Structural Silicone Sealant</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
            ...
            <div class="col-xl-3">
                <div class="all__sidebar">
                    <div class="all__sidebar-item">
                        <img src="{{ asset('assets/images/products/Neutral-vertical.jpg') }}" alt="NEUTRAL STRUCTURAL SILICONE SEALANT" class="img-fluid" loading="lazy">
                    </div>
                </div>
            </div>
        </div>
